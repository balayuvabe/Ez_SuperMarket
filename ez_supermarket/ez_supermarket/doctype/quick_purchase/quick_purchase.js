...
frappe.ui.form.on("Quick Purchase", {
  onload: function (frm) {
    ...
    frappe.model.with_doc(
      ...
      function () {
        ...
        if (settings_doc.quick_purchase == 0) {
          ...
          frappe.throw(
            "You must enable <strong>Quick Purchase</strong> feature in <a href='" +
              settings_link +
  ...
  refresh: function (frm) {
    ...
    frm.fields_dict.items.grid.add_custom_button(__("Add Items"), function () {
        ...
        fields: [
          {
            ...
            onchange: function () {
              ...
              if (item_code) {
                frappe.call({
                  method:
                    "easyerpnext.easyerpnext.doctype.quick_purchase.quick_purchase.get_item_details",
                  args: {
                    item_code: item_code,
                  },
                  callback: function (r) {
      ...
      function fetchAndSetConversionFactor(item_code, uom, frm, dialog) {
        frappe.call({
          method:
            "easyerpnext.easyerpnext.doctype.stock_in.stock_in.get_conversion_factor",
          args: {
            item_code: item_code,
            uom: uom,
          },
      ...
      function fetchAndSetBasicRate(item_code, frm, dialog) {
        frappe.call({
          method:
            "easyerpnext.easyerpnext.doctype.stock_in.stock_in.get_item_basic_rate",
          args: {
            item_code: item_code,
          },
          callback: function (r) {
    ...
    frm.fields_dict.items.grid.add_custom_button(
      ...
      function () {
        ...
        frappe.call({
          method:
            "easyerpnext.easyerpnext.custom.purchase_order.purchase_order.fetch_supplier_items",
          args: {
            supplier: supplier,
          },
          callback: function (r) {
  ...
  scan_barcode: function (frm) {
    ...
    if (barcode) {
      frappe.call({
        method:
          "easyerpnext.easyerpnext.doctype.quick_purchase.quick_purchase.get_item_details_barcode",
        args: {
          barcode: barcode,
        },
        callback: function (r) {
  ...
  mode_of_payment: function (frm) {
    ...
    frappe.call({
      method:
        "easyerpnext.easyerpnext.doctype.quick_purchase.quick_purchase.get_bank_cash_account",
      args: {
  ...
  before_submit: function (frm) {
    if (frm.doc.update_stock === 1) {
      ...
      frappe.call({
        method:
          "easyerpnext.easyerpnext.doctype.quick_purchase.quick_purchase.create_batches",
        args: {
          name: frm.doc.name,
        },
        callback: function (r) {
...
frappe.ui.form.on("Quick Purchase Items", {

...
class ProcurementMaster(BuyingController):
	...
	if TYPE_CHECKING:
		...
		advances: DF.Table[ProcurementMasterAdvance]
		...
		items: DF.Table[ProcurementMasterItem]
	...
	def __init__(self, *args, **kwargs):
		super(ProcurementMaster, self).__init__(*args, **kwargs)
		self.status_updater = [
			{
	...
	# def onload(self):
	# 	super(ProcurementMaster, self).onload()
	...
	# 	super(ProcurementMaster, self).validate()
	...
	# 	super(ProcurementMaster, self).set_missing_values(for_validate)
	...
	# 	super(ProcurementMaster, self).validate_with_previous_doc(
	# 		{
	# 			"Purchase Order": {
	...
	# 	super(ProcurementMaster, self).validate_warehouse()
	...
	# def on_submit(self):
	# 	super(ProcurementMaster, self).on_submit()
	...
	# 	if self.negative_expense_to_be_booked and valuation_tax:
	...
	# 	super(ProcurementMaster, self).on_cancel()

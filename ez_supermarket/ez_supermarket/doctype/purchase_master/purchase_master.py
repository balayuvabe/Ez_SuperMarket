...
# @frappe.whitelist()
# def calculate_purchase_quantity(doc, months):
#     items = []
...
#             GROUP BY item_code
#         """, (item.item_code, months), as_dict=True)

#         if purchase_history:
#             total_qty = sum(history.total_qty for history in purchase_history)
#             suggested_qty = total_qty // months
#             items.append({'item_code': item.item_code, 'suggested_qty': suggested_qty})
...
def on_submit(doc, method):
  create_purchase_invoice(doc.name)
	...
	# 	super(PurchaseMaster, self).validate()
	...
	# 	super(PurchaseMaster, self).set_missing_values(for_validate)
	...
	# 	super(PurchaseMaster, self).validate_with_previous_doc(
	# 		{
	# 			"Purchase Order": {
	...
	# 	super(PurchaseMaster, self).validate_warehouse()
	...
	# def on_submit(self):
	# 	super(PurchaseMaster, self).on_submit()
	...
	# 	super(PurchaseMaster, self).on_cancel()

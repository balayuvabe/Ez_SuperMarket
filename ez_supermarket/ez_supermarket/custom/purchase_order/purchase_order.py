...
def fetch_supplier_items(supplier):
    ...
    for row in item_defaults:
        ...
        items.append({
                    ...
                    "uom": item.stock_uom,
                    "custom_available_qty": f"{stall_qty or 0} / {store_rooms_qty or 0}",
                    "custom_last_month_sales": f"{last_month_sales['total_qty'] or 0} {item.stock_uom} / Rs {last_month_sales['avg_rate'] or 0}",
                    "custom_previous_last_month_sales": f"{previous_last_month_sales['total_qty'] or 0} {item.stock_uom} / Rs {previous_last_month_sales['avg_rate'] or 0}",
                    "custom_current_month_sales_2": f"{current_month_sales['total_qty'] or 0} {item.stock_uom} / Rs {current_month_sales['avg_rate'] or 0}",
                    "custom_last_month_purchase": f"{last_month_purchase['total_qty'] or 0} {item.stock_uom} / Rs {last_month_purchase['avg_rate'] or 0}",
                    "custom_previous_last_month_purchase": f"{previous_last_month_purchase['total_qty'] or 0} {item.stock_uom} / Rs {previous_last_month_purchase['avg_rate'] or 0}",
                    "custom_current_month_purchase": f"{current_month_purchase['total_qty'] or 0} {item.stock_uom} / Rs {current_month_purchase['avg_rate'] or 0}",
                    "custom_tax": item.custom_tax_rate if item.custom_tax_rate is not None else 0,
                    "custom_mrp": item.custom_mrp or 0,
                    "custom_sales_history": f"{current_month_sales['total_qty'] or 0} / {last_month_purchase['total_qty'] or 0} / {previous_last_month_purchase['total_qty'] or 0}",
                    "custom_purchase_history": f"{current_month_purchase['total_qty'] or 0} / {last_month_purchase['total_qty'] or 0} / {previous_last_month_purchase['total_qty'] or 0}",
                    "custom_purchase_rate_history": f"{current_month_purchase['avg_rate'] or 0} / {last_month_purchase['avg_rate'] or 0} / {previous_last_month_purchase['avg_rate'] or 0}",
            }
